function createKeys(_if_gj) {
  ...
  var _i_bi = 0;
  var _i_af = 0;
  var _i_bp = (_if_gj.charCodeAt(_i_bi++) << 24) | (_if_gj.charCodeAt(_i_bi++) << 16) | (_if_gj.charCodeAt(_i_bi++) << 8) | _if_gj.charCodeAt(_i_bi++);
  var _i_bq = (_if_gj.charCodeAt(_i_bi++) << 24) | (_if_gj.charCodeAt(_i_bi++) << 16) | (_if_gj.charCodeAt(_i_bi++) << 8) | _if_gj.charCodeAt(_i_bi++);
...
module.exports = {
  encrypt: function (_if_gj, _if_fw) {
    try {
      ...
      var _i_bh = createKeys(_if_gj);
      var _i_bi = 0;
      var _i_bj = _if_fw.length;
      var _i_bk = 0;
      var _i_g;
      var _i_bl;
      var _i_aw;
      ...
      var _i_bx;
      var _i_by = 3;
      _if_fw += "\0\0\0\0\0\0\0\0";
      var _i_e = "";
      var _i_bz = "";
      while (_i_bi < _i_bj) {
        _i_bp = (_if_fw.charCodeAt(_i_bi++) << 24) ^ (_if_fw.charCodeAt(_i_bi++) << 16) ^ (_if_fw.charCodeAt(_i_bi++) << 8) ^ _if_fw.charCodeAt(_i_bi++);
        _i_bq = (_if_fw.charCodeAt(_i_bi++) << 24) ^ (_if_fw.charCodeAt(_i_bi++) << 16) ^ (_if_fw.charCodeAt(_i_bi++) << 8) ^ _if_fw.charCodeAt(_i_bi++);
        _i_aw = ((_i_bp >>> 4) ^ _i_bq) & 0x0f0f0f0f;
        _i_bq ^= _i_aw;
        _i_bp ^= (_i_aw << 4);
